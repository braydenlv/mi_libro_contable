...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState==null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.contenedor_fragmentos, new FragmentoInicio()).commit();
            navigationView.setCheckedItem(R.id.nvInicio);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nvInicio) {
            ...
            ActionBar actionBar = getSupportActionBar();
            actionBar.setTitle(getString(R.string.navigation_view_ahorro_name));
        } else if (id == R.id.nvConfiguracion) {
            getSupportFragmentManager().beginTransaction().replace(R.id.contenedor_fragmentos, new FragmentoConfiguracion()).commit();
            ActionBar actionBar = getSupportActionBar();
            actionBar.setTitle(getString(R.string.navigation_view_configuracion_name));
        } else if (id == R.id.nvSalir) {
            finish();
            System.exit(0);
        }
